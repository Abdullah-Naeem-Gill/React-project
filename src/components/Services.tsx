...
const Services = () => {
  ...
  return (
    <div className="relative p-4">
        ...
        <>
          ...
          <div className="absolute top-0 left-0 right-0 mt-4 p-4 border border-gray-300 rounded bg-white z-20">
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Right Side Fields */}
              <div className="mb-4">
                <label htmlFor="therapists" className="block text-sm font-medium mb-1">
                  Required Therapists
                </label>
                <input
                  type="number"
                  id="therapists"
                  placeholder="Number of therapists required"
                  className="border border-gray-300 rounded-md p-2 w-full"
                />
              </div>
      ...
      {/* Table Section */}
      <div className="mt-36 overflow-auto"> {/* Adjusted margin to accommodate the form */}
