    ...
    <div className="p-4">
      ...
      <div className="relative bg-pink-400 h-44 shadow-md p-4">
        <div className="flex h-32 items-center text-white font-bold justify-between">
          ...
          <button className="bg-green-500 text-white mb-10 py-2 px-4 rounded hover:bg-green-600">
            Add New Booking
          </button>
        </div>
        {/* Four Horizontal Divs */}
        <div className="absolute top-0 left-0 mt-24 w-full flex justify-between p-4">
          {data.map((item, index) => (
            <div
              key={index}
              className="bg-white w-full sm:w-1/2 md:w-1/4 h-32 rounded-2xl shadow-md p-4 flex justify-between items-center"
            >
              {/* Text and Number */}
        ...
        <div className="flex flex-col md:flex-row justify-between mt-40 gap-4">
          {/* Left Div - 60% Width */}
          <div className="bg-white w-full md:w-3/5 h-48 rounded-2xl shadow-md p-6 flex flex-col">
          ...
          {/* Right Div - 40% Width */}
          <div className="bg-white w-full md:w-2/5 h-48 rounded-2xl shadow-md p-6 flex flex-col">
        ...
        <div className="flex flex-col md:flex-row justify-between mt-4 gap-4">
          <div className="bg-white w-full md:w-3/5 h-auto rounded-2xl shadow-md p-6 flex flex-col">
            ...
            <table className="min-w-full mt-2 border border-gray-300">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border-b border-gray-300 px-4 py-2">
                    <button className="border-2 border-red-400 text-red-400 py-1 px-2 rounded-lg hover:bg-red-600">
                      Cancelled
                    </button>
                  </td>
                </tr>
          ...
          <div className="bg-white w-full md:w-2/5 h-auto rounded-2xl shadow-md p-6 flex flex-col">
